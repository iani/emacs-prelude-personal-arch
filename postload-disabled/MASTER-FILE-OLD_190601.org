...
* COMMENT TRANSFER DONE export babel blocks
  :PROPERTIES:
...
* COMMENT TRANSFER DONE packages
  :PROPERTIES:
...
* COMMENT TRANSFER DONE calendar set corfu coordinates and euopean date style
  :PROPERTIES:
...
* COMMENT TRANSFER DONE moe theme powerline delimiter faces
  :PROPERTIES:
...
* COMMENT OBSOLETE Fullscreen toggle and native use
  :PROPERTIES:
...
#+END_SRC
* COMMENT TRANSFER DONE parenthesis-colors
  :PROPERTIES:
...
* COMMENT TRANSFER DONE load-some-useful-package-avy-jump-etc
  :PROPERTIES:
...
#+END_SRC
* COMMENT OBSOLETE god and evil modes
  :PROPERTIES:
...
* COMMENT TRANSFER DONE whitespace and visual line fixes
  :PROPERTIES:
...
#+END_SRC
* COMMENT TRANSFER DONE turn off auto fill in text mode
  :PROPERTIES:
...
#+END_SRC
* COMMENT TRANSFER DONE multiple-cursors
  :PROPERTIES:
...
* COMMENT BUGGY prelude-customization
  :PROPERTIES:
...
* CANCELED org-split-hugo
  CLOSED: [2019-06-15 Sat 07:37]
  :PROPERTIES:
...
#+BEGIN_SRC emacs-lisp
  ...
  ;; This package only makes it easier to use ox-hugo

  ;;; Code:

  (prelude-require-package 'ox-mdx-deck) ;; this makes sure you get ox-hugo
