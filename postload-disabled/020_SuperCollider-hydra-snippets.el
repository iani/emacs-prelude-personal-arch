...
(defhydra hydra-snippets (
  ...
  ("t" sclang-toggle-current-snippet-routine "toggle snippet routine")
...
(defun sclang-toggle-current-snippet-routine ()
  "If current snippet is routine, toggle start/stop status."
  (interactive)
